...
export class HtmlEditorComponent implements OnInit {
  ...
  defaultEditorOptions = {
    ...
    file_picker_callback: function(callback, value, meta) {
      ...
      window['tinymce'].execCommand('ocAssetPicker', true, { callback, value, meta})
    },
    ...
    images_upload_handler: function(blobInfo, successCallback, errorCallback) {
      // importing tinymce breaks things so we have to use instance from window
      window['tinymce'].execCommand('ocAssetUploader', true, { blobInfo, successCallback, errorCallback})
    },
  ...
  ngOnInit(): void {
    ...
    Object.assign(this.resolvedEditorOptions, this.defaultEditorOptions, this.editorOptions);
  }
}
